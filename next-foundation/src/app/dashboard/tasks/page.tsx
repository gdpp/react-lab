  ...
  const tasks = [
    {
      ...
      description:
        "Create the initial repository and configure basic project structure.",
      status: "Completed",
      dueDate: "2026-01-01",
    },
    {
      ...
      description:
        "Define entities, relationships, and indexes for the main database.",
      status: "In Progress",
      dueDate: "2026-01-05",
    },
    {
      ...
      description: "Add JWT-based authentication and role authorization.",
      status: "Pending",
      dueDate: "2026-01-10",
    },
  ];
